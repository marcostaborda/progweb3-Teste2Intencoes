package progweb3.poa.ifrs.edu.testintencao2;
...
public class MainActivity extends ListActivity {
    ...
    private void discar(){
        Uri uri = Uri.parse("tel:988776655");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            // Abrindo uma URL
            case 0:
                uri = Uri.parse("http://poa.ifrs.edu.br");
            ...
            case 2:
                uri = Uri.parse("geo:0,0?q=Rua+Coronel Vicente,Porto Alegre");
                intent = new Intent(Intent.ACTION_VIEW, uri);
                dispararIntent(intent);
                break;
            ...
            case 7:
                intent = new Intent(Intent.ACTION_SEARCH)
                        .putExtra(SearchManager.QUERY, "IFRS");
                dispararIntent(intent);
                break;
            ...
            // Ação customizada 1
            case 9:
                intent = new Intent("progweb3.poa.ifrs.edu.ACAO_CUSTOMIZADA");
                dispararIntent(intent);
                break;
            // Ação customizada 2
            case 10:
